...
VALUES 
    ...
    (3, 'camille.rousseau@email.com', 'Juliette', 'Plantevin', '$2a$12$1aX8Ldlhto/wk2ds5ju9UOBbqlbtWpOKayi6pqTOVgzfuSYFo55EC', false, NOW(), NOW());
...
VALUES 
    ...
    (2, 'Hélène', 'THIERCELIN', NOW(), NOW()),
    (3, 'Sophie', 'MARTIN', NOW(), NOW());
